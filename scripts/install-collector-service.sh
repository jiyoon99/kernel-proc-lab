...
make collector
sudo install -D -m 0755 kernel-lab-collector /usr/lib/kernel-proc-lab/kernel-lab-collector
sudo install -D -m 0755 scripts/kernel-lab-system.sh /usr/bin/kernel-lab
